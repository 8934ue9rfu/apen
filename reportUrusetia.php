...
$sql = "
   SELECT 
    ...
    WHERE 
        markah.totalMark IS NOT NULL -- Include only records with non-null totalMark
    GROUP BY 
                            ...
                            <?php foreach ($evaluatedEntries as $entry): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="statusUrusetia.php?id=<?php echo $entry['userID']; ?>" class="btn" style="background-color: #b58868; color: white;">Lihat Rekod</a>
